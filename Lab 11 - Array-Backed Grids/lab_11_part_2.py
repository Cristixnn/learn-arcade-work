...
class MyGame(arcade.Window):
    ...
    def on_mouse_press(self, x, y, button, key_modifiers):
            ...
            for column in range(COLUMN_COUNT):
                ...
                if self.grid[row][column] == 0:
                    if continuous_count > 2:
                        print("Row " + str(row) + " has " + str(
                            continuous_count) + " continuous blocks selected.")
                    continuous_count = 0
            if continuous_count > 2:
                print("Row " + str(row) + " has " + str(
                    continuous_count) + " continuous blocks selected.")
            print("Row " + str(row) + " has " + str(
                number_row_cells_selected) + " cells selected.")
        ...
        for column in range(COLUMN_COUNT):
            ...
            print("Column " + str(column) + " has " + str(
                number_column_cells_selected) + " cells selected.")
        print("")
